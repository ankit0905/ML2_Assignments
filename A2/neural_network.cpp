class NeuralNetwork
{
    private:
        ...
        vector<vector<double> > weights_ji, weights_kj, T_k, d_E_wkj, d_E_wji, prediction, X_i, Z_j, delta_k, delta_j;
...
NeuralNetwork::NeuralNetwork(vector<pair<vector<double>, int> > train_data, int no_hidden_units=10)
{
